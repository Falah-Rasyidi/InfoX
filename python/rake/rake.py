...
if test:
    ...
    text = "Generate a funny meme about the latest sports news"
    ...
    keyword_candidates = generate_candidate_keyword_scores(phraseList, wordscores)
    if debug: print(keyword_candidates)

    sorted_keywords = sorted(iter(keyword_candidates.items()), key=operator.itemgetter(1), reverse=True)
    if debug: print(sorted_keywords)

    totalKeywords = len(sorted_keywords)
    if debug: print(totalKeywords)
    # print(sorted_keywords[0:(totalKeywords / 3)])
